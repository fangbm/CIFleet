...
func (b *Backend) Kind() model.BackendKind { return model.BackendHyperV }
func (b *Backend) Capacity(context.Context) (model.Capacity, error) {
	return model.Capacity{}, errors.New("HyperV backend capacity probe not implemented")
}
func (b *Backend) Create(context.Context, backend.JobSpec) (*backend.Instance, error) {
	return nil, errors.New("HyperV backend create not implemented")
}
func (b *Backend) Destroy(context.Context, string) error {
	return errors.New("HyperV backend destroy not implemented")
}
